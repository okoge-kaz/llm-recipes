...
CHECKPOINT_DIR=/bb/llm/gaf51275/checkpoints/llm-recipes/Llama-3.2-3B/LR_2.5E-5_minLR_2.5E-6_WD_0.1_GC_1
...
OUTPUT_DIR=/bb/llm/gaf51275/2024/checkpoints/pytorch-to-hf/Llama-3.2-3B/from-base/
...
HF_REPO_NAME="tokyotech-llm/Llama-3.2-3B-from-base-${EXP_NAME}-${FORMATTED_ITERATION}"
