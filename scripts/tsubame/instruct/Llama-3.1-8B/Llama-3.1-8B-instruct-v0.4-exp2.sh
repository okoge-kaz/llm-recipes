...
CHECKPOINT_SAVE_DIR="/gs/bs/tga-NII-LLM/checkpoints/Llama-3.1-8B-Instruct-v0.4/exp2/LR_${LR}_MINLR_${MIN_LR}_WD_${WEIGHT_DECAY}_GC_${GRAD_CLIP}"
...
TRAIN_DATA_PATH=${DATASET_DIR}/train_mixed.jsonl
VALID_DATA_PATH=${DATASET_DIR}/train_mixed.jsonl

# job name
JOB_NAME="Llama-3.1-8B-instruct-v0.4-exp2-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}-WD=${WEIGHT_DECAY}-GC=${GRAD_CLIP}"
