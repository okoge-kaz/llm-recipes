...
CHECKPOINT_DIR=/gs/bs/tga-NII-LLM/hf-checkpoints/Llama-3.1-Swallow-8B-v0.2
CHECKPOINT_SAVE_DIR="/gs/bs/tga-NII-LLM/checkpoints/Llama-3.1-8B-Instruct-v0.4/exp3-stage1/LR_${LR}_MINLR_${MIN_LR}_WD_${WEIGHT_DECAY}_GC_${GRAD_CLIP}"

mkdir -p ${CHECKPOINT_SAVE_DIR}

# dataset
DATASET_DIR=/gs/bs/tga-NII-LLM/datasets/raw/instruct/training/v0.4

TRAIN_DATA_PATH=${DATASET_DIR}/code_sample_1m.jsonl
VALID_DATA_PATH=${DATASET_DIR}/code_sample_1m.jsonl

# job name
JOB_NAME="Llama-3.1-8B-instruct-v0.4-exp3-stage1-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}-WD=${WEIGHT_DECAY}-GC=${GRAD_CLIP}"
