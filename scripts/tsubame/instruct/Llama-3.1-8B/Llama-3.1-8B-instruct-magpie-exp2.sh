...
CHECKPOINT_SAVE_DIR="/gs/bs/tga-NII-LLM/checkpoints/Llama-3.1-8B-Instruct/magpie-exp2/LR_${LR}_MINLR_${MIN_LR}_WD_${WEIGHT_DECAY}_GC_${GRAD_CLIP}"

mkdir -p ${CHECKPOINT_SAVE_DIR}

# dataset
DATASET_DIR=/gs/bs/tga-NII-LLM/datasets/raw/instruct/MAGPIE/Synthetic-JP-Conversations-Magpie-Nemotron-4-10k

TRAIN_DATA_PATH=${DATASET_DIR}/train_6146.jsonl
VALID_DATA_PATH=${DATASET_DIR}/train_6146.jsonl

# job name
JOB_NAME="Llama-3.1-8B-instruct-magpie-exp2-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}-WD=${WEIGHT_DECAY}-GC=${GRAD_CLIP}"
