...
CHECKPOINT_DIR=/gs/bs/tga-NII-LLM/checkpoints/fsdp-to-hf/Llama-3.3-70B-Instruct-v0.1/iter_0002968
CHECKPOINT_SAVE_DIR="/gs/bs/tga-NII-LLM/checkpoints/Llama-3.3-70B-Instruct-v0.1/stage2/LR_${LR}_MINLR_${MIN_LR}_WD_${WEIGHT_DECAY}_GC_${GRAD_CLIP}"
...
TRAIN_DATA_PATH=${DATASET_DIR}/train_general.jsonl
VALID_DATA_PATH=${DATASET_DIR}/train_general.jsonl

# job name
JOB_NAME="Llama-3.3-70B-instruct-v0.1-stage2-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}-WD=${WEIGHT_DECAY}-GC=${GRAD_CLIP}"
