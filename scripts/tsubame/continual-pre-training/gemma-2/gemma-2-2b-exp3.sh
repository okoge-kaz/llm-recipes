...
CHECKPOINT_SAVE_DIR="/gs/bs/tgh-24IDU/checkpoints/gemma-2-2b/exp3/LR_${LR}_MINLR_${MIN_LR}_WD_${WEIGHT_DECAY}_GC_${GRAD_CLIP}"
...
# job name
JOB_NAME="Gemma-2-2b-Exp-3-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}-WD=${WEIGHT_DECAY}-GC=${GRAD_CLIP}"
