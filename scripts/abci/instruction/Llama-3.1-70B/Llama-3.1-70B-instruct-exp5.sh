...
CHECKPOINT_DIR=/bb/llm/gaf51275/hf-checkpoints/Meta-Llama-3.1-70B-Instruct
CHECKPOINT_SAVE_DIR="/bb/llm/gaf51275/checkpoints/Llama-3.1-70B-Instruct/exp5/LR_${LR}_MINLR_${MIN_LR}_WD_${WEIGHT_DECAY}_GC_${GRAD_CLIP}"
...
# job name
JOB_NAME="Llama-3.1-70B-instruct-exp5-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}-WD=${WEIGHT_DECAY}-GC=${GRAD_CLIP}"
